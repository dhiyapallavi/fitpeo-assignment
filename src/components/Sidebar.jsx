...
import { BiLeftArrowCircle, BiSolidChevronRight } from "react-icons/bi";
...
const menuItem = (menu, key) => {
  return (
    <li
      key={key}
      className="relative  text-gray-200 text-sm rounded-md pl-2 py-2 my-1.5 transition-all duration-200 hover:bg-blue-900 cursor-pointer"
    >
      ...
      <aside
        className={
          isOpen
            ...
            : `fixed lg:static flex flex-col translate-x-[-250px] w-[250px] bg-blue-950 shadow-xl h-screen hidden`
        }
      >
        <div className="flex flex-col h-[90vh]">
          <h4 className="flex justify-start items-center text-gray-200 text-xl font-semibold px-2 py-6 mx-3">
